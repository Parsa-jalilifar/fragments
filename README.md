...
$ npm run test                   // To run the test functions
$ npm run test:watch             // To run the test functions and it comes with a menu
$ npm run coverage               // To generate a report to see test coverage
$ npm run test:integration       // To run the Hurl tests
```
